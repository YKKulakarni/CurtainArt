...
function Rating({ totalStars = 5 }) {
    ...
    return (
        <div className='w-full h-fit flex flex-1 items-center justify-center flex-col'>
            <div className="rating w-full h-auto p-10 bg-gray-800 text-white flex flex-col md:flex-row items-center justify-around md:h-[40vh]" id='rating'>
                {/* Left Section */}
                ...
                {/* Center Section */}
                <div className="rating-center flex items-center justify-center gap-2 bg-slate-50 rounded-md shadow-[2px_2px_5px_rgba(0,0,0,0.4)] p-3 mb-4 md:mb-0">
                    <FcGoogle className='size-7' />
                    <p className="text-sm position-relative top-2 text-slate-800 md:text-[1.2vw]">{rating} Rating</p>
